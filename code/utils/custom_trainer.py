"""
This file incorporates code from the project neuraloperator
available at https://github.com/neuraloperator/neuraloperator/, licensed under the MIT License. 
Modifications made by Christina Runkel, 2024.
"""
import torch
...
class CustomTrainer:
    ...
    def log_epoch(
        ...
        if self.wandb_log:
            wandb.log(values_to_log, step=epoch + 1, commit=True)
